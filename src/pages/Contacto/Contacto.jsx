    ...
    <div className="bg-white overflow-x-hidden">
      <section className="pt-16 pb-10 px-4 md:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <FadeIn delay={80}>
              <img src={tallerImg} alt="Taller NETI" className="w-full h-full object-cover rounded-2xl" style={noSelect} draggable={false} />
            </FadeIn>

            <FadeIn delay={140}>
              <div>
                <h2 className="font-sans text-2xl md:text-3xl font-bold text-[#251B37] mb-5">El universo de la innovación</h2>
                ...
                <blockquote className="font-sans text-sm italic text-[#85789A] leading-relaxed mb-5 pl-4 border-l-2 border-[#EC4E8D]">
                  "Tendemos a sobrestimar el efecto de una tecnología a corto plazo y a subestimar el efecto a largo plazo". — Roy Amara
                </blockquote>
                ...
                <div className="space-y-5 mb-8">
                  <div>
                    <p className="font-sans font-bold text-[#251B37] text-base mb-2">¿Querés hacer un taller con nosotros?</p>
                    <Link to="/servicios" className="inline-flex items-center gap-2 font-sans font-semibold text-[#EC4E8D] hover:gap-3 transition-all duration-200">
                      Servicios <svg className="w-4 h-4" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M5 12h14M12 5l7 7-7 7" /></svg>
                    </Link>
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-6 flex-wrap mt-2">
                  <button onClick={() => setModalAbierto(true)} className="font-display font-black text-lg uppercase tracking-widest px-8 py-3 border-2 border-[#251B37] text-[#251B37] hover:bg-[#251B37] hover:text-white transition-all duration-200">
                    Contacto
                  </button>
      ...
      <FadeIn delay={60}>
        <div className="w-full my-10">
          <img src={bannerImg} alt="NETI comunidad" className="w-full object-cover max-h-52" style={noSelect} draggable={false} />
        </div>
      </FadeIn>
      ...
      <section className="pt-8 pb-16 px-4 md:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <FadeIn delay={100}>
            <img src={losEsperamosImg} alt="Comunidad NETI" className="w-full object-cover rounded-2xl" style={noSelect} draggable={false} />
          </FadeIn>
        </div>
      </section>
