        ...
        <div className="bg-white overflow-x-hidden">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        {infoCards.map((card, i) => (
                            <FadeIn key={i} delay={i * 80} className="h-full">
                                <div className="flex flex-col items-center justify-start gap-3 p-5 bg-white rounded-2xl border border-[#E6E2EE] h-full"
                                    style={{ boxShadow: '0 0 18px 2px rgba(103,88,155,0.08)' }}>
            ...
            <section className="py-20 px-4 md:px-8">
                <div className="max-w-5xl mx-auto">
                    <FadeIn>
                        <h2 className="font-display text-4xl md:text-6xl font-black text-center mb-14 uppercase tracking-widest"
                            style={{ WebkitTextStroke: "2px #EC4E8D", color: "transparent" }}>
                            4 Módulos
                        </h2>
                    </FadeIn>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                        {modulos.map((mod, i) => (
                            <FadeIn key={i} delay={i * 80} className="h-full">
                                <div
                                    className="flex flex-col relative p-6 rounded-2xl border border-[#E6E2EE] bg-white overflow-hidden h-full"
                                    style={{ boxShadow: '0 0 18px 2px rgba(103,88,155,0.08)' }}
                                >
                                    {/* Número decorativo */}
                                    <div
                                    ...
                                    {/* Dot acento */}
                                    <div className="w-3 h-3 rounded-full mb-4" style={{ background: mod.color }} />
